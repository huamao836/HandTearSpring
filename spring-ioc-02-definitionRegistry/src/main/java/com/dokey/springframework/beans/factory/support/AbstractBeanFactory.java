...
/**
 * dokey@step#definitionRegistry: 第二步：创建抽象bean工厂类实现BeanFactory
 *
...
public abstract class AbstractBeanFactory implements BeanFactory {
    ...
    /**
     * dokey@step#definitionRegistry:第三步:：用来存放bean定义的map
     */
    protected ConcurrentHashMap<String, Object> beanMap = new ConcurrentHashMap();


    /**
     * dokey@step#definitionRegistry: 第四步：获取bean如果不存在则实例化bean
     * @param beanName
     * @return
